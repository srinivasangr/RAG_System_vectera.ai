...
Produces THREE artifacts per page, instead of v1's flat child-chunk list:
  ...
  2. ChunkV2[]    — child chunks for lexical retrieval, each carrying:
...
from rag_system.ingest.chunk import (
    ChunkType,
...
class PageChunks:
    parent: ParentChunk
    children: list[ChunkV2] = field(default_factory=list)
